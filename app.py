...
def process_data():
    ...
    try:
        ...
        # 8) Test subset stats
        avg_corrected = mean_absolute_error(master_df['true_velocity'], master_df['corrected_velocity'])
        avg_true = mean_absolute_error(master_df['true_velocity'], master_df['true_velocity'])  # Should be zero
        ...
        results = {
            "average_velocities_on_test_dataset": {
                "Average_Corrected_Velocity": mae_corrected,
                "Average_True_Velocity": 0.0,  # Since avg_true is MAE of true vs true
